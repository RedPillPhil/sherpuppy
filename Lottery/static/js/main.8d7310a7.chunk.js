		...
		856: function(e, t, n) {
			...
			var K = n(408),
				...
				ee = function(e) {
					...
					var x = new j.eth.Contract(K, "0xfff5361f6b97eb2225208665f973cef019a14c13");
						...
						var e = Object(y.a)(A.a.mark((function e() {
							...
							return A.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									...
									case 3:
										return e.prev = 3, e.next = 6, Promise.all([i(b), n.methods.usertotalEntries(b).call().catch((function(e) {
											return console.error("myentries", e), 0
