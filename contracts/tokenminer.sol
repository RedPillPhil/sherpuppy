...
contract SherpuppyMiner is Context, Ownable {
    ...
    function setbusdToken(address busd) public onlyOwner {
    busdToken =  busd;
    ...
    function sellEggs() public {
        ...
        ERC20(busdToken).transfer(dead, fee);
        ERC20(busdToken).transfer(address(msg.sender), SafeMath.sub(eggValue,fee));
    }
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        ERC20(busdToken).transferFrom(address(msg.sender), address(this), amount);
        uint256 balance = ERC20(busdToken).balanceOf(address(this));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256) {
        return calculateTrade(eggs,marketEggs,ERC20(busdToken).balanceOf(address(this)));
    }
    ...
    function calculateEggBuySimple(uint256 eth) public view returns(uint256){
        return calculateEggBuy(eth,ERC20(busdToken).balanceOf(address(this)));
    }
    ...
    function getBalance() public view returns(uint256) {
        return ERC20(busdToken).balanceOf(address(this));
    }
